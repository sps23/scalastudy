...
object ArrayVariableLength {
  ...
  val nums1: ArrayBuffer[Int] = ArrayBuffer[Int]()
  val nums2: ArrayBuffer[Int] = new ArrayBuffer[Int]
  val nums3: ArrayBuffer[Int] = new ArrayBuffer[Int]

  //add element to the end
  nums1 += 1
  //add collection to the end
  nums1 ++= Seq(1, 2, 3, 5)
  nums3 ++= Seq(1, 2, 3, 4, 5, 6)

  //append any collection to the end
  nums2 ++= Array(8, 13, 21)
  nums2 ++= ArrayBuffer(13, 56, 63, 73, 91)
  nums2.dropRightInPlace(2)
