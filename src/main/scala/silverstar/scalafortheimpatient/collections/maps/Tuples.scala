...
//  private val tupleStudent3 = ("John", "male", 25)
  ...
  def printTupleScores(t: Tuple3[Int, Double, String]): Unit = {
    println(t._1.toString + ": " + t._3 + " = " + t._2.toString)
  }

  def printTupleStudent(t: Tuple3[String, String, Int]): Unit = {
    println("name: " + t._1 + ";\tsex: " + t._2 + ";\tage=" + t._3.toString)
  }

  def printZippedSymbols(symbols: Array[String], counts: Array[Int]): Unit = {
